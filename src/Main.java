        ...
        switch (option) {
            case 1:
                ...
                if (bmi <= 18.5) {
                    ...
                    System.out.printf("Your BMI is: %.2f, you have obesity class 1", bmi);
                } else if (bmi >= 34.9 && bmi <= 39.9) {
                    System.out.printf("Your BMI is: %.2f, you have obesity class 2", bmi);
                } else {
                    System.out.printf("Your BMI is: %.2f, you have obesity class 3", bmi);
                }
                break;
